...
class StardewValleyPlugin(GamePlugin):
	"""Stardew Valley — save game locations.

	Saves are located under AppData/Roaming/StardewValley/Saves.
	"""
	...
	@property
	def poster(self) -> str:
		return "https://cdn.cloudflare.steamstatic.com/steam/apps/413150/capsule_616x353.jpg"
